...
function AuthModal({
    ...
    return (
        <div className={`modal-overlay ${isOpen ? 'active' : ''}`} id="loginModalOverlay" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
            <div className={`modal-content login-modal ${showSignup ? 'show-signup' : ''}`} id="authModalContent">
                <button className="modal-close" id="loginModalClose" onClick={onClose}>&times;</button>
                <div className="login-view">
                    ...
                    <button className="google-login-btn" id="googleLoginButton">
                    ...
                    <p className="modal-toggle-link">
                        Não tem uma conta? <span id="showSignupLink" onClick={() => onToggleSignup(true)}>Cadastre-se</span>
                    </p>
                </div>
                <div className="signup-view">
                    <h3>Crie sua Conta</h3>
                    <form id="signupForm" onSubmit={onSignupSubmit}>
                        <div className="form-group-modal">
                    ...
                    <p className="modal-toggle-link">
                        Já tem uma conta? <span id="showLoginLink" onClick={() => onToggleSignup(false)}>Entre</span>
                    </p>
                </div>
            </div>
        </div>
